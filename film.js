...
//Funkce pro generování HTML kódu obrázku
const generateImageHTML = (url, width, height) => {
    return `
        <img
            src="${url}"
            alt="plakát"
...
// Funkce pro generování HTML kódu pro filmovou kartu
const generateMovieCardHTML = (filmData) => {
    return `
        <div class="col-md-5">
            ${generateImageHTML(filmData.plakat.url, filmData.plakat.sirka, filmData.plakat.vyska)}
        </div>
		<div class="col-md-7">
						<div class="card-body">
...
// Přidání vygenerovaného HTML do příslušných prvků
const detailFilmu = document.querySelector('.col-md-5');
detailFilmu.innerHTML = generateImageHTML(filmData.plakat.url, filmData.plakat.sirka, filmData.plakat.vyska);

const detailFilmu2 = document.querySelector('.card-body');
detailFilmu2.innerHTML = generateMovieCardHTML(filmData);
